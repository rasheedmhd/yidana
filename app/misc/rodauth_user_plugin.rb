...
class RodauthUserPlugin < RodauthPlugin
  configure do
    ...
    create_reset_password_email do
      RodauthUserMailer.reset_password(self.class.configuration_name, account_id, reset_password_key_value)
    end

    create_verify_account_email do
      RodauthUserMailer.verify_account(self.class.configuration_name, account_id, verify_account_key_value)
    end

    create_verify_login_change_email do |_login|
      RodauthUserMailer.verify_login_change(self.class.configuration_name, account_id, verify_login_change_key_value)
    end

    create_password_changed_email do
      RodauthUserMailer.change_password_notify(self.class.configuration_name, account_id)
    end

    create_reset_password_notify_email do
      RodauthUserMailer.reset_password_notify(self.class.configuration_name, account_id)
    end
